Contributing to BitalGO Core
============================

The BitalGO Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/bitalgo-project/bitalgo/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BitalGO Core project, and is not to be
confused with overall BitalGO Network Protocol consensus changes.

Whether a pull request is merged into BitalGO Core rests with the project merge
...
Patches that change BitalGO consensus rules are considerably more involved than
...
Where a patchset proposes to change the BitalGO consensus, it must have been
...
The project leader is the release manager for each BitalGO Core release.
