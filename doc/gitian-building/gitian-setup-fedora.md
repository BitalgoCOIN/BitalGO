...
The build script we'll be using is contained in the BitalGO github repository ([contrib/gitian-build.py](https://github.com/bitalgo-project/bitalgo/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the BitalGO repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/BitalGO-Project/BitalGO/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, bitalgo-detached-sigs, and bitalgo GitHub repos.
