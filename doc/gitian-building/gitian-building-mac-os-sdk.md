...
The script [extract-osx-sdk.sh](https://github.com/bitalgo-project/bitalgo/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
bitalgo/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/bitalgo-project/bitalgo/blob/master/doc/README_osx.md) for troubleshooting tips.
