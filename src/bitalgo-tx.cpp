...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BitalGO Core bitalgo-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitalgo-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitalgo transaction") + "\n" +
                               "  bitalgo-tx [options] -create [commands]   " + _("Create hex-encoded bitalgo transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitalgo transaction
