...
/** Utility functions used by the BitalGO Qt UI.
 */
namespace GUIUtil
{
...
// Render BitalGO addresses in monospace font
...
// Parse "bitalgo:" URI into recipient object, return true on successful parsing
