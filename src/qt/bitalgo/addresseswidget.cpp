...
#include "qt/bitalgo/forms/ui_addresseswidget.h"
#include "qt/bitalgo/addresslabelrow.h"
#include "qt/bitalgo/addnewaddressdialog.h"
#include "qt/bitalgo/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(BitalGOGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination algAdd = DecodeDestination(address.toUtf8().constData(), isStakingAddress);
        ...
        if (walletModel->updateAddressBookLabels(algAdd, label.toUtf8().constData(),
