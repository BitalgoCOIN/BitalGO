...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, BitalGOGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, BitalGOGUI* gui, double posX = 3);
