...
#include "qt/bitalgo/topbar.h"
#include "qt/bitalgo/forms/ui_topbar.h"
#include "qt/bitalgo/lockunlock.h"
#include "qt/bitalgo/qtutils.h"
#include "qt/bitalgo/receivedialog.h"
#include "qt/bitalgo/loadingdialog.h"
...
TopBar::TopBar(BitalGOGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopAlg}, "amount-small-topbar");
    setCssProperty({ui->labelAmountAlg}, "amount-topbar");
    setCssProperty({ui->labelPendingAlg, ui->labelImmatureAlg}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("BitalGO")
    updateDisplayUnit();
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // ALG Total
    QString totalAlg = GUIUtil::formatBalance(balance, nDisplayUnit);

    // ALG
    // Top
    ui->labelAmountTopAlg->setText(totalAlg);
    // Expanded
    ui->labelAmountAlg->setText(totalAlg);
    ui->labelPendingAlg->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureAlg->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
