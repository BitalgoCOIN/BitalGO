...
#include "qt/bitalgo/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(BitalGOGUI* _window, QWidget *parent) :
