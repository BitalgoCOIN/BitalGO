...
#include "qt/bitalgo/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(BitalGOGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &BitalGOGUI::openFAQ);
