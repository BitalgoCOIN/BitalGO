...
#include "qt/bitalgo/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/bitalgo/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(BitalGOGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the BitalGO RPC console.") + "<br>" +
