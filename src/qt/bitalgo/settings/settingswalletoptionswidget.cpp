...
#include "qt/bitalgo/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/bitalgo/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(BitalGOGUI* _window, QWidget *parent) :
