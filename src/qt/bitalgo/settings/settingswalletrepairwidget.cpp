...
#include "qt/bitalgo/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/bitalgo/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(BitalGOGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to BitalGOGUI::handleRestart()
