...
#include "qt/bitalgo/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/bitalgo/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(BitalGOGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableALG,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableALG,
    ...
    connect(ui->pushButton_UnspendableALG, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableALG);});
    ...
    if (parent)
        connect(parent, &BitalGOGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
