...
#include "qt/bitalgo/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(BitalGOGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("BitalGO_tx_csv_export(*.csv)") : tr("BitalGO_addresses_csv_export(*.csv)"),
                                        nullptr);
