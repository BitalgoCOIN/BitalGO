...
#ifndef BitalGO_CORE_NEW_GUI_BitalGOGUI_H
#define BitalGO_CORE_NEW_GUI_BitalGOGUI_H
...
#include "qt/bitalgo/navmenuwidget.h"
#include "qt/bitalgo/topbar.h"
#include "qt/bitalgo/dashboardwidget.h"
#include "qt/bitalgo/send.h"
#include "qt/bitalgo/receivewidget.h"
#include "qt/bitalgo/addresseswidget.h"
#include "qt/bitalgo/coldstakingwidget.h"
#include "qt/bitalgo/masternodeswidget.h"
#include "qt/bitalgo/snackbar.h"
#include "qt/bitalgo/settings/settingswidget.h"
...
/**
  BitalGO GUI main class. This class represents the main window of the BitalGO UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BitalGOGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BitalGOGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~BitalGOGUI();
...
#endif //BitalGO_CORE_NEW_GUI_BitalGOGUI_H
