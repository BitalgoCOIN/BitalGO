...
#include "qt/bitalgo/sendcustomfeedialog.h"
#include "qt/bitalgo/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(BitalGOGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &BitalGOGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
