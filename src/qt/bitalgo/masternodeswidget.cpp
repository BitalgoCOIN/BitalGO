...
#include "qt/bitalgo/forms/ui_masternodeswidget.h"

#include "qt/bitalgo/qtutils.h"
#include "qt/bitalgo/mnrow.h"
#include "qt/bitalgo/mninfodialog.h"
#include "qt/bitalgo/masternodewizarddialog.h"
...
#include "util.h"
#include "qt/bitalgo/optionbutton.h"
#include <iostream>
#include <fstream>
...
MasterNodesWidget::MasterNodesWidget(BitalGOGUI *parent) :
    PWidget(parent),
    ...
    if (fs::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:2706 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= (COIN * 2000)) {
        inform(tr("Not enough balance to create a masternode, 2000 %1 required.").arg(CURRENCY_UNIT.c_str()));
        return;
    }
    showHideOp(true);
