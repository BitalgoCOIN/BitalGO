...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            BitalGOGUI* window = static_cast<BitalGOGUI*>(parentWidget());
...
{
    BitalGOGUI* gui = static_cast<BitalGOGUI*>(parentWidget());
...
{
    hide();
    static_cast<BitalGOGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("BitalGO will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your ALGs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
