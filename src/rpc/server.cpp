...
CAmount AmountFromValue(const UniValue& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > 25200000.0)
...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "BitalGO server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BitalGO features */
        {"bitalgo", "listmasternodes", &listmasternodes, true, true, false},
        {"bitalgo", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitalgo", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bitalgo", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bitalgo", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bitalgo", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitalgo", "masternodedebug", &masternodedebug, true, true, false},
        {"bitalgo", "startmasternode", &startmasternode, true, true, false},
        {"bitalgo", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitalgo", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitalgo", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitalgo", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitalgo", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitalgo", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitalgo", "preparebudget", &preparebudget, true, true, false},
        {"bitalgo", "submitbudget", &submitbudget, true, true, false},
        {"bitalgo", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitalgo", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitalgo", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitalgo", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitalgo", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitalgo", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitalgo", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitalgo", "checkbudgets", &checkbudgets, true, true, false},
        {"bitalgo", "mnsync", &mnsync, true, true, false},
        {"bitalgo", "spork", &spork, true, true, false},
...
{
    return "> bitalgo-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2705/\n";
}
