...
enum WalletFeature {
    ...
    FEATURE_PRE_BitalGO = 61000, // inherited version..
...
public:
    ...
    static const CAmount DEFAULT_STAKE_SPLIT_THRESHOLD = 10 * COIN;
    ...
    /// Get 10000 ALG output and keys which can be used for the Masternode
